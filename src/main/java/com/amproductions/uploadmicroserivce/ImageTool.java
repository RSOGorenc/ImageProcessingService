...
public class ImageTool {
    ...
    public static byte[] processImage(byte[] inputImage, int maxWidth,  int maxHeight) {
        try {
            ...
            BufferedImage resized = performResize(image, maxWidth, maxHeight);
    ...
    private static BufferedImage performResize(BufferedImage inputImage, int maxWidth,  int maxHeight){
